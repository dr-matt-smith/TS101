...
Copied dist/.DS_Store from public/.DS_Store
Copied dist/css/styles.css from public/css/styles.css
```

We see the following:
- `dist/game.js` created from `src/main.ts`
- `dist/game.js` copied from `public/index.html`
- ` dist/.DS_Store` copied from ` dist/.DS_Store`
  - we can just ignore `.DS_Store` files (they are a kind of macOS thumbnail ...)
